  ...
  return (
    <div className="flex justify-between pt-2 mt-1">
      <button
        ...
        className={`flex items-center justify-center w-1/3 py-1 rounded-md hover:cursor-pointer ${
      ...
      <button className="flex items-center justify-center w-1/3 text-gray-600 hover:bg-gray-100 cursor-pointer py-1 rounded-md">
